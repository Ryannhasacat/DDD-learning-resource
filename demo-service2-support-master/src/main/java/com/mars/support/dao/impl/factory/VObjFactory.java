 ...
 */
package com.mars.support.dao.impl.factory;

import java.util.HashMap;
import java.util.Map;

import com.mars.support.xml.XmlBuildFactoryTemplate;
...
public class VObjFactory extends XmlBuildFactoryTemplate {
	 ...
	 */
	public VObjFactory() {
		if(vObjMap!=null && !vObjMap.isEmpty()) {
			return;
		}
	...
	public static VObj getVObj(String clazz) {
		...
		if(vObj==null) {
			throw new DaoException("Not found the value object["+clazz+"] in the vObj.xml!");
		}
		return vObj;
	}
