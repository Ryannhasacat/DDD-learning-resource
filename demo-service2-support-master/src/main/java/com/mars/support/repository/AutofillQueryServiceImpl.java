...
import com.mars.support.dao.impl.factory.VObj;
import com.mars.support.exception.QueryException;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.context.ApplicationContext;

import com.mars.support.dao.impl.factory.Join;
import com.mars.support.dao.impl.factory.Ref;
import com.mars.support.dao.impl.factory.VObjFactory;
...
public class AutofillQueryServiceImpl extends QueryServiceImpl {
	...
	public BasicDao getDao() {
		if(dao==null) {
			throw new QueryException("The dao is null");
		}
		return dao;
	}
	/**
	...
	private <S extends Serializable, T extends Entity<S>> void autoFillJoin(List<T> list, Join join) {
		if(list==null||list.isEmpty()||join==null) {
			return;
		}
	...
	private <S extends Serializable, T extends Entity<S>> void autoFillRef(List<T> list, Ref ref) {
		if(list==null||list.isEmpty()||ref==null) {
			return;
		}
